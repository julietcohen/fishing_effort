...
![](pictures/fishing_gfw_map_2019.png)

#### **Global fishing activity from January 1, 2020 through January 1, 2021.**
![](pictures/fishing_gfw_map_2020.png)
...
![](pictures/flag_vessels_gfw_map.png)
...
Global Fishing Watch's data includes fishing effort and vessel information from 124 countries over the years 2012-2020. First, we select our variables of interest, group by country, and take the fishing effort means per year.
...
We can make a country-specific fishing effort plot by filtering our *actual* fishing effort data to just that country, appending the *predicted* 2020 fishing effort data for that country that we produced through
