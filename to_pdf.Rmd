...
# #models[[4]]
models
countries_in_models <- unique(as.character(countries_clean$flag_gfw))
countries_in_models
# 
...
![Malaysia's Fishing Effort: Actual vs Predicted 2017-2020](pictures/malaysia_fishing_effort_legend.png){width=70%}
...
gtsave(data = good_bad_table, filename = "good_bad_table_correct.png", path = here())
```
