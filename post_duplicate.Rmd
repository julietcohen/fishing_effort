...
```{r}
# an alternative way to run linear model on each country:
# lm_with_do_function <- countries_clean %>% 
#   group_by(flag_gfw) %>% 
...
# models[[4]] call just one set of coefficients
# models call all sets of coefficients

prediction_data = NULL;
for (i in 1:length(models)) {
  predicted_effort_2020 <- models[[i]][1] + models[[i]][2]*4
